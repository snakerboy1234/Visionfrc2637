...
public class GripPipelineTape {
	...
	//Outputs
		...
		public void process(Mat source0) {
			...
			double[] hslThresholdHue = {51.588220948664805, 101.261703564454};
			double[] hslThresholdSaturation = {180.89232004227125, 255.0};
			double[] hslThresholdLuminance = {91.24293785310734, 223.1818181818182};
